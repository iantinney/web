...
/**
 * Generate a concise, descriptive title for a study plan using the LLM
 * Returns a 1-2 word title that's unit-appropriate
 */
export async function generateStudyPlanTitle(lessonPlanText: string): Promise<string> {
